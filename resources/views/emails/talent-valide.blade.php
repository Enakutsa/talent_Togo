                ...
                <table width="500" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:30px;">
                            <h2 style="color:#1e7e34; margin-top:0;">Félicitations {{ $talent->prenom }} 🎉</h2>
                            <p>Votre profil talent a été <strong style="color:#1e7e34;">validé</strong> par notre équipe.</p>
                            <p>Vous êtes désormais visible par les clients sur TalentTogo et pouvez recevoir des demandes de prestation.</p>
